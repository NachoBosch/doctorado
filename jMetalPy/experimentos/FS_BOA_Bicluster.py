...
model_name = "BIC"
jobs = configure_experiment(problems={"BIC_BOA": Bic.BiclusteringProblem(data)},
                            n_run=10)

output_directory = make_dir(f"{os.getcwd()}/results/Resultados_BOA/experimentos/",model_name)
