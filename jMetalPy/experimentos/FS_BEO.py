...
for model_name, model in zip(models_names,models):
    jobs = configure_experiment(problems={"FS_BEO": fsh.FeatureSelectionHD(data,alfa,model)},
                                n_run=20)

    output_directory = make_dir(f"{os.getcwd()}/results/Resultados_BEO/experimentos/",model_name,alfa)
