...
# alg_ls = ['BACO','BALO','BEO','BGPC','BOA','GWO','SA','SS','uGA','SGA','BPSO','DE','BHHO']
alg_ls = ['SS','uGA','SGA','DE','CGA']
for alg in alg_ls:
    dir_name = f'results/Resultados_{alg}/cursoCE'
...
def analyze_all_algorithms(df):
    ...
    for algorithm in ['SS','uGA','SGA','DE','CGA']:
