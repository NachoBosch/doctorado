...
for model_name, model in zip(models_names[1:],models[1:]):
    jobs = configure_experiment(problems={"FS_BHHO": fsh.FeatureSelectionHD(data,alfa,model)},
                                n_run=20)

    output_directory = make_dir(f"{os.getcwd()}/results/Resultados_BHHO/experimentos/",model_name,alfa)
